...
Treat Gemma4:26b as a deliberate reasoning worker, not a low-latency chat worker. A future smaller/faster model should be considered for quick classification, command routing, triage, and other latency-sensitive control-plane tasks.
